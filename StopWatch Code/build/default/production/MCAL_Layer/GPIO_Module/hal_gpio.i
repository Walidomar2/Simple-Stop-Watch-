# 1 "MCAL_Layer/GPIO_Module/hal_gpio.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "MCAL_Layer/GPIO_Module/hal_gpio.c" 2
...
# 1 "MCAL_Layer/GPIO_Module/hal_gpio.h" 1
# 13 "MCAL_Layer/GPIO_Module/hal_gpio.h"
...
# 13 "MCAL_Layer/GPIO_Module/hal_gpio.h" 2

# 1 "MCAL_Layer/GPIO_Module/../mcal_std_types.h" 1
# 13 "MCAL_Layer/GPIO_Module/../mcal_std_types.h"
# 1 "MCAL_Layer/GPIO_Module/../std_libraries.h" 1
# 10 "MCAL_Layer/GPIO_Module/../std_libraries.h"
...
# 10 "MCAL_Layer/GPIO_Module/../std_libraries.h" 2
...
# 11 "MCAL_Layer/GPIO_Module/../std_libraries.h" 2
...
# 12 "MCAL_Layer/GPIO_Module/../std_libraries.h" 2
# 13 "MCAL_Layer/GPIO_Module/../mcal_std_types.h" 2

# 1 "MCAL_Layer/GPIO_Module/../compiler.h" 1
# 11 "MCAL_Layer/GPIO_Module/../compiler.h"
...
# 11 "MCAL_Layer/GPIO_Module/../compiler.h" 2
# 14 "MCAL_Layer/GPIO_Module/../mcal_std_types.h" 2
...
# 14 "MCAL_Layer/GPIO_Module/hal_gpio.h" 2

# 1 "MCAL_Layer/GPIO_Module/../device_config.h" 1
# 15 "MCAL_Layer/GPIO_Module/hal_gpio.h" 2
...
# 75 "MCAL_Layer/GPIO_Module/hal_gpio.h"
...
# 8 "MCAL_Layer/GPIO_Module/hal_gpio.c" 2
...
Std_ReturnType gpio_pin_direction_init(const Pin_Config_t *_pin_config){
    ...
    else
    {
        switch(_pin_config->Direction){
             case OUTPUT:
                 (*tris_regs[_pin_config->Port] &= ~(1 << _pin_config->Pin));
                 break;
             ...
             default : ret_value = (Std_ReturnType)0x00 ;
          }
     }
...
Std_ReturnType gpio_pin_get_direction_status(const Pin_Config_t *_pin_config ,Direction_t *dir_status){
    ...
    {
        *dir_status = ((*tris_regs[_pin_config->Port] >> _pin_config->Pin)& 1);
    }
    return ret_value ;
}
...
Std_ReturnType gpio_pin_write_logic(const Pin_Config_t *_pin_config , Logic_t logic){
    ...
    else
    {
        switch(logic){
             case LOW:
                 (*lat_regs[_pin_config->Port] &= ~(1 << _pin_config->Pin));
...
Std_ReturnType gpio_pin_read_logic(const Pin_Config_t *_pin_config , Logic_t *logic){
    ...
    {
        *logic= ((*port_regs[_pin_config->Port] >> _pin_config->Pin)& 1);
    }
    return ret_value ;
