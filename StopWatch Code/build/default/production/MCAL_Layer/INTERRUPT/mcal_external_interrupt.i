...
# 1 "MCAL_Layer/INTERRUPT/../GPIO_Module/hal_gpio.h" 1
# 15 "MCAL_Layer/INTERRUPT/../GPIO_Module/hal_gpio.h"
# 1 "MCAL_Layer/INTERRUPT/../GPIO_Module/../device_config.h" 1
# 15 "MCAL_Layer/INTERRUPT/../GPIO_Module/hal_gpio.h" 2
...
# 75 "MCAL_Layer/INTERRUPT/../GPIO_Module/hal_gpio.h"
...
Std_ReturnType Interrupt_INTx_Enable(const interrupt_INTx_t *object){
    Std_ReturnType ret_value=(Std_ReturnType)0x00;
    if(((void*)0) == object){
...
static Std_ReturnType Edge_Config(const interrupt_INTx_t *object){
    ...
    else
    {
        switch(object->INTx_pin.Pin){
                case PIN0:
                    if( object->edge == INTERRUPT_FALLING_EDGE ) { (INTCON2bits.INTEDG0=0); }
                    else if ( object->edge == INTERRUPT_RISING_EDGE ) { (INTCON2bits.INTEDG0=1);}
                    else{ }
                    ret_value = (Std_ReturnType)0x01;
                    break;
                case PIN1:
                    if(object->edge == INTERRUPT_FALLING_EDGE) { (INTCON2bits.INTEDG1=0); }
                    else if (object->edge == INTERRUPT_RISING_EDGE) { (INTCON2bits.INTEDG1=1); }
                    else{ }
                    ret_value = (Std_ReturnType)0x01;
                    break;
                case PIN2:
                    if(object->edge == INTERRUPT_FALLING_EDGE) { (INTCON2bits.INTEDG2=0); }
                    else if(object->edge == INTERRUPT_RISING_EDGE) { (INTCON2bits.INTEDG2=1); }
                    else{ }
                    ret_value = (Std_ReturnType)0x01;
                    break;
                default : ret_value = (Std_ReturnType)0x00;
